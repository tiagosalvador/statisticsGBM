function [areas_grains,areas_convhull, mdf, nNeighbors, isopratio] = compute_statistics2D(grains,dims,ori,dt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [areas_grains,areas_convhull, mdf, nNeighbors, isopratio] = compute_statistics2D(grains,dims,ori,dt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Computes different grain statistics for 2D grains
...
for k = 1:N
    for l = (k+1):N
        if aux(k,l)
            mdf(end+1,1) = misorientation_angle2d_aux(ori(k),ori(l));

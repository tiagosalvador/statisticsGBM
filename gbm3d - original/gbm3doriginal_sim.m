function gbm3doriginal_sim(dt,grains,dims,ori,Rgrains,Rfamilies,angBrandon,list_t,filename)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% gbm3doriginal_sim(dt,grains,dims,ori,Rgrains,Rfamilies,angBrandon,list_t,filename)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t = 1:max(list_t)% Main time iteration starts.
    ...
    if ismember(t,list_t)
        ...
        save_variable(filename,ID,['ID_t',num2str(epoch),'_original'])

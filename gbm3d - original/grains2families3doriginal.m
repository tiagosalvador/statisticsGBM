function [families,famgrains] = grains2families3doriginal(grains,R,dims)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [families,famind] = grains2families3doriginal(grains,R,dims)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
maxlabel = 0;
families = cell(maxFamilies,3); % Maximum of 100 families anticipated.

function gbm2doriginal_sim(dt,grains,dims,ori,Rgrains,Rfamilies,angBrandon,list_t,filename)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% gbm2doriginal_sim(dt,grains,dims,ori,Rgrains,Rfamilies,angBrandon,list_t,filename)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2D grain boundary motion with many grains. Isotropic, unequal
% surface tensions given by Read-Shockley.
...
%% Auxiliary vars.
global WORKSPACE KERNEL Z ORI ID;
...
for t = 1:max(list_t)% Main time iteration starts.
    ...
    if ismember(t,list_t)
        ...
        save_variable(filename,grains,['grains_t',num2str(epoch),'_original'])
        save_variable(filename,orio,['ori_t',num2str(epoch),'_original'])
        save_variable(filename,t,['t',num2str(epoch),'_original'])
        display_progress(1,1,1);
    end
